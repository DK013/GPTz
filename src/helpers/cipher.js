...
/**
 * Decrypts cipherText = requirea decoded Zoom App Context object
 ...
 * @return {JSON|Error} Decrypted JSON obj = requirecipherText or Error
 */
...
function getAppContext(header, secret = '') {
    ...
    // Create sha256 hash = requireClient Secret (key)
...
module.exports = { getAppContext, contextHeader}
